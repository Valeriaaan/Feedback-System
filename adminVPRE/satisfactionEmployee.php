        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="list-group">
                    ...
                    <a href="satisfactionEmployee.php" class="list-group-item list-group-item-action active"><i class="fas fa-user-tie me-2"></i> Employee</a>
                    <a href="satisfactionOther.php" class="list-group-item list-group-item-action"><i class="fas fa-users me-2"></i> Other Customer</a>
                    <a href="satisfactionResearch.php" class="list-group-item list-group-item-action"><i class="fas fa-book-open me-2"></i> Research</a>
                </div>
            ...
            <!-- Main Content -->
            <div class="col-md-10">
                <h2>Overall Employee Satisfaction</h2>
