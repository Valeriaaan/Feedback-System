        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="list-group">
                    ...
                    <a href="satisfactionResearch.php" class="list-group-item list-group-item-action active "><i class="fas fa-book-open me-2"></i> Research</a>
                </div>
            ...
            <!-- Main Content -->
            <div class="col-md-10">
                <h2>Overall Research Satisfaction</h2>
