...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    <h4 class="mb-4">4. Timeless of service</h4>

                    <div class="mb-4">
                        <p>A. Requests, inquiries, and feedback are handled and responded to promptly</p>
                    ...
                    <div class="mb-4">
                        <p>B. Services and technology delivered timely</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>C. Reports/Deliverables are submitted on time</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>D. Prescribed requirements for the funded research are complied with</p>
                        <div class="likert-scale">
                            <div class="scale-1">
