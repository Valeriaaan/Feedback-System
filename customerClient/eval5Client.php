...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    <h4 class="mb-4">5. Cost Effectiveness/Efficiency of Project</h4>

                    <div class="mb-4">
                        <p>A. Use of local expertise/resources</p>
                    ...
                    <div class="mb-4">
                        <p>
                            B. Budget is utilized based on the approved budgetary requirements
                            (e.g., not exceeding budget, full utilization of budget)
                        </p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>C. The project is completed ahead of time</p>
                        <div class="likert-scale">
                            <div class="scale-1">
