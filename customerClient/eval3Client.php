...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    <h4 class="mb-4">3. Customer Relations</h4>

                    <div class="mb-4">
                        <p>A. Researchers and/or Staff are courteous and helpful</p>
                    ...
                    <div class="mb-4">
                        <p>B. Researchers and Staffs listen and communicate well</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>C. Researchers and Staffs listen and communicate well</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>D. Researchers and Staff are organized and systematic in the delivery of service</p>
                        <div class="likert-scale">
                            <div class="scale-1">
