...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    <h4 class="mb-4">1. Quality of Research Services</h4>

                    <div class="mb-4">
                        <p>A. Research data/information - accuracy and completeness of data, adequacy of data analysis, etc</p>
                    ...
                    <div class="mb-4">
                        <p>B. Relevance/Acceptability - usability of data/information generated, relevance of project to community, etc</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>C. Ethical conduct, e.g., in relation to data consent and protection(if applicable)</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>D. Effectiveness, i.e., research is achieving objective, impact of the project on people’s lives</p>
                        <div class="likert-scale">
                            <div class="scale-1">
