    ...
    <div class="container-fluid vh-100 d-flex">
        <div class="row flex-fill">
            ...
            <div class="col-lg-7 d-flex flex-column  align-items-center bg-white text-center p-3 mt-5">
                ...
                <div class="d-grid gap-3 my-5 py-5 w-50">
                    <a href="adminVPRE/loginVPRe.php">
                        <button class="btn btn-red mt-5 w-100" type="button">VPRE</button>
                    </a>
                    <a href="adminOfficeHead/loginOfficeHead.php">
                        <button class="btn btn-red w-100" type="button">Office Head</button>
                    </a>
