...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    <h4 class="mb-4">5. Others</h4>

                    <div class="mb-4">
                        <p>
                            A. Effectiveness of the   activity in meeting personal objectives 
                            ( Pagiging epektibo ng kasanayan o   gawain sa pagkamit ng mga pansariling layunin)
                        </p>
                    ...
                    <div class="mb-4">
                        <p>B. Timeliness of the activity (Pagsasagawa ng kasanayan sa takdang oras)</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>C. Timeliness of the activity (Pagsasagawa ng kasanayan sa takdang oras)</p>
                        <div class="likert-scale">
                            <div class="scale-1">
