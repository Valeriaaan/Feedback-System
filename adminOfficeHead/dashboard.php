        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-11">
                ...
                <ul class="nav nav-tabs justify-content-between p-1" id="settingsTabs" role="tablist">
                    <div class="d-flex">
                        <li class="nav-item">
                            <a class="nav-link" href="printReport.php"><i class="fas fa-print"></i> Print Report</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../landingPage.php"><i class="fas fa-sign-out"></i> Logout</a>
                        </li>
                    </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h4>Customers</h4>
                                <canvas class="my-1"id="pieChart"></canvas>
