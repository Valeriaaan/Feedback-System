        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action active">Extension (Agency)</a>
                    <a href="#" class="list-group-item list-group-item-action">Extension (Beneficiary)</a>
                </div>
                <div class="d-flex justify-content-center">
                    <a href="satisfactionEmployee.php"class="btn btn-transparent mt-3"><i class="fas fa-arrow-left me-2"></i> Back</a>
                </div>
            </div>

            <!-- Main Content -->
            <div class="col-md-10">
                <h2>Detailed Extensions Satisfaction Result</h2>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container-fluid my-4">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action active">Teaching Staff</a>
                    <a href="#" class="list-group-item list-group-item-action">Non-Teaching Staff</a>
                </div>
                <div class="d-flex justify-content-center">
                    <a href="satisfactionEmployee.php"class="btn btn-transparent mt-3"><i class="fas fa-arrow-left me-2"></i> Back</a>
                </div>
            ...
            <!-- Main Content -->
            <div class="col-md-10">
                <h2>Detailed Employee Satisfaction</h2>
