        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action active">College of Education</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Arts and Sciences</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Business and Public Administration</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Computing and Multimedia Studies</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Agriculture and Natural Resources</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Trade and Technology</a>
                    <a href="#" class="list-group-item list-group-item-action">College of Engineering</a>
                    <a href="#" class="list-group-item list-group-item-action">Entienza Campus</a>
                </div>
                <div class="d-flex justify-content-center">
                    <a href="satisfactionStudent.php"class="btn btn-transparent mt-3"><i class="fas fa-arrow-left me-2"></i> Back</a>
                </div>
            </div>

            <!-- Main Content -->
            <div class="col-md-10">
                <h2>Detailed Student Satisfaction Result</h2>
                ...
                <div class="col-md-12">
                        <div class="card my-4">
                            <div class="card-body">
                                <h4>Insights</h4>
                                <div id="wordCloudContainer" style="height: 350px;"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card mb-4" >
                            <div class="card-body">
                                ...
                                <canvas class="mb-3" id="barChart"></canvas>
                            </div>
                        </div>
                    </div>
