        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-10">
                <div class="card p-4">
                    ...
                    <div class="mb-4">
                        <p>1. Objectives of   the activity</p>
                    ...
                    <div class="mb-4">
                        <p>3. Contribution of the activity to community development</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                    ...
                    <div class="mb-4">
                        <p>6. Efficient utilization of funds (if applicable)</p>
                        <div class="likert-scale">
                            <div class="scale-1">
                                <input type="radio" id="q4-1" name="q4" value="1">
                                <label for="q4-1">&#8205;</label>
